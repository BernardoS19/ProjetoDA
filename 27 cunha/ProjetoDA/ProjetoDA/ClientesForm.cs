...
namespace ProjetoDA
{
    public partial class ClientesForm : Form
    {
        ...
        private void listBoxCarrendamentos_SelectedIndexChanged(object sender, EventArgs e)
        {
            // apresenta os dados dos arrendamentos
            fKClienteArrendamentoBindingSource.DataSource = clienteContainer.ArrendamentoSet.Local.ToBindingList();
        }
    }
}